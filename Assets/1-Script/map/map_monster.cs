...
public class map_monster : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (people_map.which_monster == 1 && BattleSystem.monster_alive == false
        )
        {
            // monster1.SetActive(false);
            monster1_alive = false;
            ...
            people_map.which_monster == 2 && BattleSystem.monster_alive == false
        )
        {
            // monster2.SetActive(false);
            monster2_alive = false;
            ...
            people_map.which_monster == 3 && BattleSystem.monster_alive == false
        )
        {
            // monster3.SetActive(false);
            monster3_alive = false;
